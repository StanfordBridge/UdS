...
# 
# It serves as a comparison for another line of RL approaches, 它可以作为另一种RL方法的比较，
# which utilize Q learning in the basic tabular form.在基本表格形式中使用Q-learning
#
...
BR_LV = 3  # number of bitrate levels
...
REBUF_PENALTY = 1.85  # 1 sec rebuffering -> 3 Mbps
SMOOTH_PENALTY = 1
M_IN_K = 1000.0
BITS_IN_BYTE = 8.0
TEST_INTERVAL = 1000
