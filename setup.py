...
# matplotlib   YES==3.5.3
os.system("sudo apt-get -y install python-matplotlib")

# copy the webpage files to /var/www/html   YES
os.chdir( start_dir )
...
# need to copy the trace and pre-trained NN model    YES
